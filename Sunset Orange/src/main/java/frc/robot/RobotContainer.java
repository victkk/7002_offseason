...
public class RobotContainer {
  ...
  public void pushChooser() {
    ...
    mChooser.addOption("TL", new TH31L(sDrivetrainSubsystem, sIntaker, sShooter));
    mChooser.addOption("Tt", new mid33With51Fallback52(sDrivetrainSubsystem, sIntaker, sShooter));
    mChooser.addOption("TBH31H", new TBH31H(sDrivetrainSubsystem, sIntaker, sShooter));
